...
def build_pdf_text_block_id(doc_index: int, page_index: int, span_index: int) -> str:
    """Build a PDF-style block ID for text spans."""
    return build_pdf_block_id(doc_index, page_index, 0, 0, span_index)
